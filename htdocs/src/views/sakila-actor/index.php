...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\SakilaActorSearch $searchModel
*/
...
?>
<div class="giiant-crud sakila-actor-index">
    ...
    <h1>
        <?= Yii::t('models', 'Sakila Actors') ?>        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [            [
                ...
                'url' => ['sakila-film/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('models', 'Sakila Film') . '</i>',
            ],]
            ],
            'options' => [
            'class' => 'btn-default'
