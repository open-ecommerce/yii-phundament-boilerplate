...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $imgPath; ?>/img/favicon/apple-touch-icon.png">
        <link rel="icon" type="image/png" href="<?php echo $imgPath; ?>/img/favicon/favicon-32x32.png" sizes="32x32">
        <link rel="icon" type="image/png" href="<?php echo $imgPath; ?>/img/favicon/favicon-16x16.png" sizes="16x16">
        <link rel="manifest" href="<?php echo $imgPath; ?>/img/favicon/manifest.json">
        <link rel="mask-icon" href="<?php echo $imgPath; ?>/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
